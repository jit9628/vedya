 ...
 -->
				...
				<div class="col-12 col-md-12 col-lg-4">
					<div class="d-block mb-3">
						...
						<ul
							class="list-group list-group-sm list-group-flush-y list-group-flush-x mb-4"
							id="appendeddatacheckout">
...
<a href="./shop.html"> <img src="${pageContext.request.contextPath}/resources/upload_file/${var.filesretrieve[0]}"alt="img" class="img-fluid"></a>
 ...
 --%>
					...
					<div>
						<button href="#"
							class="btn btn_Checkout btn-block btn-dark mb-5 mt-3"
							id="placeorder">Place Your Order</button>
					</div>
				</div>
			</div>
