...
<body>
 ...
 --%>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/addToCart.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/responseMessage.js"
		type="text/javascript"></script>
